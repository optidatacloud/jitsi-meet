...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'eumedia.optiwork.cloud',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'eumedia.optiwork.cloud',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.eumedia.optiwork.cloud',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'eumedia.optiwork.cloud',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://eumedia.optiwork.cloud/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://eumedia.optiwork.cloud/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.eumedia.optiwork.cloud',
    ...
    //     // by default uses:
    //     // 'https://eumedia.optiwork.cloud/static/oauth.html'
    //     redirectURI:
    //          'https://eumedia.optiwork.cloud/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:eumedia.optiwork.cloud:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.eumedia.optiwork.cloud',
