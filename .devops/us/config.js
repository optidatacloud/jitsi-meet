...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'usmedia.optiwork.cloud',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'usmedia.optiwork.cloud',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.usmedia.optiwork.cloud',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'usmedia.optiwork.cloud',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://usmedia.optiwork.cloud/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://usmedia.optiwork.cloud/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.usmedia.optiwork.cloud',
    ...
    //     // by default uses:
    //     // 'https://usmedia.optiwork.cloud/static/oauth.html'
    //     redirectURI:
    //          'https://usmedia.optiwork.cloud/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:usmedia.optiwork.cloud:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.usmedia.optiwork.cloud',
