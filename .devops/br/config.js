...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'call.optidata.cloud',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'call.optidata.cloud',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.call.optidata.cloud',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'call.optidata.cloud',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://call.optidata.cloud/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://call.optidata.cloud/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.call.optidata.cloud',
    ...
    //     // by default uses:
    //     // 'https://call.optidata.cloud/static/oauth.html'
    //     redirectURI:
    //          'https://call.optidata.cloud/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:call.optidata.cloud:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.call.optidata.cloud',
