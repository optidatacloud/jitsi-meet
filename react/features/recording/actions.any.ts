 ...
 * @param {boolean} useOnlyUi - Whether to use only the UI to start the recording or not.
 * @returns {Object}
 */
export function startLocalVideoRecording(onlySelf?: boolean, useOnlyUi?: boolean) {
    return {
